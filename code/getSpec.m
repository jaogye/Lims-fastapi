  ...
  case 'CLI'
    ...
    sql = "SELECT "+ scols +" FROM spec s, product p, quality q " ...
     ...
     dd = table( d.Action, d.Customer, d.Product, d.Quality, d.Status, ...
        d.Certificate , d.Opm, d.COA, d.Day_COA, d.COC, d.Visual, d.OneDecimal ) ;
     ...
     dd.Properties.VariableNames{6} = 'Certificate' ; 
     ...
     dd.Properties.VariableNames{12} = 'OneDecimal' ;
